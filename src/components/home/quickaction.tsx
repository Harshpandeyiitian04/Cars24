...
export default function Quickaction() {
    return(
        <>
            <div className="py-8 px-4 sm:px-8 relative z-20 -mt-12">
                <div className="flex flex-wrap justify-center bg-white rounded-lg shadow-md p-4 mx-auto max-w-4xl">
                    {actions.map((action)=>(
                        <Link key={action.name} href={action.href} className="w-1/2 sm:w-1/3 p-3 text-center transition-transform hover:scale-105">
